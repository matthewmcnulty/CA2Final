...
# Step 2: 
# Show the total number of rows, the structure of the data frame, 
...
# it is a good idea to merge the columns together since they both have 
...
# Postcode is an important component of the address, and is 
# essential in the answering of section 2.
...
# Step 9: 
# Save the modified NIPostcode dataset 
